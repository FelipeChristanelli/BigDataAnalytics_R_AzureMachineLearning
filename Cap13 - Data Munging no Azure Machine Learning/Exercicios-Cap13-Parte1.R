...
modelo <- naiveBayes(Class ~ ., trainHouseVotes84)
...
# Treine o modelo
?naiveBayes
predicao <- predict(modelo, testHouseVotes84)

# Confusion Matrix
confusao <- table(testHouseVotes84$Class, predicao)
confusao

# Média
mean(predicao == testHouseVotes84$Class)
