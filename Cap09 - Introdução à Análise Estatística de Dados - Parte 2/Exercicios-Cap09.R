...
hist(x, probability = TRUE, ylim = c(0, 1.80), breaks = 20, main = "Histrograma de x")
...
# estamos interessados na cauda superior da distribuição.
...
# A taxa de processamento de um checkout é igual a uma dividida pelo tempo médio de conclusão de finalização.
...
# Para encontrar a probabilidade de ter 4 ou menos respostas corretas por tentativas aleatórias,
